...
// Mengimpor lebih banyak ikon untuk visual yang lebih baik
...
const DonatePage = () => {
  ...
  return (
    // Latar belakang gradien yang lebih lembut dan modern
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 relative">
      ...
      >
        ...
        <form onSubmit={handleFormSubmit} className="space-y-8">
          ...
          {/* STEP 2: Data Diri (Disederhanakan) */}
          <div>
            <label className="block text-sm font-semibold text-slate-600 mb-3">
              ...
              {paymentMethods.map((method) => (
                ...
                >
                  ...
                  <div className={`ml-auto h-5 w-5 rounded-full border-2 flex items-center justify-center ${
                      selectedPayment === method.id ? 'border-orange-500 bg-orange-500' : 'border-slate-400'
                  }`}>
          ...
          <div>
            <button
              type="submit"
              className="w-full flex justify-center py-4 px-4 rounded-lg font-semibold text-white bg-orange-500 hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition-all duration-300 transform hover:translate-y-[-2px] active:translate-y-0 shadow-lg hover:shadow-xl"
            >
              Lanjutkan Donasi Rp {Number(amount).toLocaleString('id-ID')}
            </button>
          </div>
        </form>
      </motion.div>
